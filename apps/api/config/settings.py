...
PRECONSTRUCTION_CAD_PREVIEW_MAX_ITEMS = int(
    os.getenv("PRECONSTRUCTION_CAD_PREVIEW_MAX_ITEMS", "800") or "800"
)
PRECONSTRUCTION_DWG_CONVERTER_COMMAND = os.getenv("PRECONSTRUCTION_DWG_CONVERTER_COMMAND", "").strip()
PRECONSTRUCTION_DWG_CONVERTER_TIMEOUT_SECONDS = int(
    os.getenv("PRECONSTRUCTION_DWG_CONVERTER_TIMEOUT_SECONDS", "180") or "180"
)
PRECONSTRUCTION_DOCUMENT_OCR_ENABLED = (
    os.getenv("PRECONSTRUCTION_DOCUMENT_OCR_ENABLED", "true").strip().lower() not in {"0", "false", "no", "off"}
)
PRECONSTRUCTION_DOCUMENT_OCR_COMMAND = os.getenv("PRECONSTRUCTION_DOCUMENT_OCR_COMMAND", "tesseract").strip() or "tesseract"
PRECONSTRUCTION_DOCUMENT_OCR_TIMEOUT_SECONDS = int(
    os.getenv("PRECONSTRUCTION_DOCUMENT_OCR_TIMEOUT_SECONDS", "30") or "30"
)
PRECONSTRUCTION_DOCUMENT_OCR_SCALE = float(
    os.getenv("PRECONSTRUCTION_DOCUMENT_OCR_SCALE", "2") or "2"
)
PRECONSTRUCTION_DOCUMENT_OCR_MIN_TEXT_CHARS = int(
    os.getenv("PRECONSTRUCTION_DOCUMENT_OCR_MIN_TEXT_CHARS", "24") or "24"
)
PRECONSTRUCTION_LINEAR_ROUND_STEP_FEET = os.getenv("PRECONSTRUCTION_LINEAR_ROUND_STEP_FEET", "0.0001")
PRECONSTRUCTION_AREA_ROUND_STEP_SQFT = os.getenv("PRECONSTRUCTION_AREA_ROUND_STEP_SQFT", "0.0001")
PRECONSTRUCTION_CUBIC_ROUND_STEP_CY = os.getenv("PRECONSTRUCTION_CUBIC_ROUND_STEP_CY", "0.0001")
PRECONSTRUCTION_LINEAR_WASTE_FACTOR = os.getenv("PRECONSTRUCTION_LINEAR_WASTE_FACTOR", "0")
PRECONSTRUCTION_AREA_WASTE_FACTOR = os.getenv("PRECONSTRUCTION_AREA_WASTE_FACTOR", "0")
